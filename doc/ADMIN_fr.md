...
Rendez-vous sur la page [__DOMAIN__](https://__DOMAIN__) pour créer le premier utilisateur.  
...
- installer à la racine de ce sous-domaine l'application _Redirect_ en mode `reverse_proxy`et la faire pointer sur http://127.0.0.1:__PORT_FRONTEND__
